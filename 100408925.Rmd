...
![Original graph, source: NYT](original_map.png){width="1000" height="550"}
...
The provided R code below checks if the "extrafont" package is already installed, and if not, it installs the package. Subsequently, it loads the "extrafont" library. The code then imports the "Lora" font using the **`font_import`** function, making it available for use.
...
**At the end the final plot should look like this:**

![Resulting plot](Final_plot.png)
